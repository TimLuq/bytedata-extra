...
/// The macintosh charset.
const MACINTOSH_CHARSET: [char; 128] = {
...
#[doc(alias = "mac_os_roman")]
#[cfg_attr(docsrs, doc(cfg(feature = "macintosh")))]
...
#[cfg_attr(docsrs, doc(cfg(feature = "macintosh")))]
impl core::default::Default for Macintosh {
    #[inline]
    fn default() -> Self {
        Self::new()
    }
...
#[cfg_attr(docsrs, doc(cfg(feature = "macintosh")))]
impl crate::Charset for Macintosh {
    const CHARSET_NAME: &'static str = "macintosh";
...
#[cfg_attr(docsrs, doc(cfg(feature = "macintosh")))]
impl crate::CharsetDecoding for Macintosh {
    #[inline]
...
#[cfg_attr(docsrs, doc(cfg(feature = "macintosh")))]
impl crate::CharsetEncoding for Macintosh {
    #[inline]
